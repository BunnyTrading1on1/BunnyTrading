        ...
        <div className="wrap">
          <div className="section-head">
            ...
            <p>
              ...
              course. It&rsquo;s one-on-one mentorship built around a single
              idea: the trade you take matters less than the rule you took it
              under.
            </p>
          </div>
        </div>
        ...
        <div className="wrap">
          <div className="section-head">
            ...
            <p>
              ...
              more than 1% per trade, size the position to the stop &mdash;
              never the other way around, require at least 1:2 reward to
              risk, and write the reason down before entry, not after.
              Position sizing isn&rsquo;t a suggestion here; it&rsquo;s the
              first thing you learn and the thing every trade review checks
              first.
            </p>
          </div>
        </div>
